...
<body>
    <div class="bg-[url('img/fondo.jpg')] bg-cover min-h-scree">
        <div>
            <h2 class="text-4xl font-bold text-white">Agregar Televisores</h2>
            <div id="respuesta" class="text-white"></div>
        </div>
        <div class="flex w-full justify-center gap-20">
            <div class="flex flex-col gap-10">
                <div class="bg-white rounded-md p-4 shadow-md max-w-lg w-full">
            ...
            <table class="shadow-md max-w-3xl w-full overflow-x-auto rounded-b-md">
                <thead>
